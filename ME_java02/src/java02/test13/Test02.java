...
public class Test02 {
	...
	public static void main(String[] args) {
		...
		// new 명령으로 인스턴스 생성 불가능
		MyClass x2 = new ();
		*/
		
		// snapshot 2: 클래스 정의와 인스턴스 생성 문장을 합친다.
		// 이때, 서브 클래스의 이름이 없기 때문에 생성자는 수퍼 클래스의 생성자를 지정한다.
		/*
		...
		*/
		...
		// 한 번만 사용하는 인스턴스를 만들 때는 익명 이너 클래스로 만들어라.
		...
		// 익명 이너 클래스의 생성자를 지정할때 수퍼 클래스의 생성자를 지정한다.
