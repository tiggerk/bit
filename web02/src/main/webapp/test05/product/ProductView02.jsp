...
<div class='col-sm-10'>
<input type='text' class='form-control' readonly id='no' name='no' value='<%=product.getNo()%>'>
</div>
</div>
<div class='form-group'>
...
<div class='col-sm-10'>
<input type='text' class='form-control' id='qty' name='qty' value='<%=product.getQuantity()%>'>
</div>
</div>
<div class='form-group'>
<label for='mkno' class='col-sm-2 control-label'>제조사</label>
<div class='col-sm-10'>
<input type='text' class='form-control' id='mkno' name='mkno' value='<%=product.getMakerNo()%>'>
</div>
</div>
<div class='form-group'>
