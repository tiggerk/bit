...
insert into MEMBERS(UID, PWD, EMAIL, UNAME, TEL)
values('u03', '1111', 'u03@test.com', '유관', '111-1111');
...
/* 문제: 위의 결과를 출력할 때 아이디와 이름의 라벨명(alias)을 id, name으로 바꿔라
 * 컬럼명 as 별명 
 * 컬럼명 별명  <== as 생략가능
 * 컬럼명 (as) 별명
 */
...
update ORDERS set QTY=3, ODATE='2014-11-09'
where ONO=6;
...
/* ALTER
ALTER TABLE MEMBERS ADD BAS_ADDR VARCHAR(255);  => 컬럼 추가
ALTER TABLE MEMBERS MODIFY BAS_ADDR VARCHAR(255);  => 컬럼 수정
 */
