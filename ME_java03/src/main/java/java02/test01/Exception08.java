/* finally block
   - try block에서 예외가 발생하던 안하던 반드시 실행하는 block
   - try block에서 생성한 resource를 해제하는 코드를 둔다.
 */
...
public class Exception08 {
	...
	public static void main(String[] args) {
		...
		// compute에서 발생된 예외를 중간의 메서드에서는 처리할 필요가 없다.
		// 이렇게 처음 호출자가 통합하여 처리하면 된다.
		// 오류 관리가 쉽고, 코드가 간결해진다.
		try {
		printPage();
